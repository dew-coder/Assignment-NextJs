  ...
  return (
    <div>
      <div className="flex  justify-between items-center border border-b border-r-0 w-[100%]  ">
        ...
        <LoginLink postLoginRedirectURL="/dashboard" className=" items-center font-bold rounded-lg flex gap-4 md:border-2 border-2 border-slate-300 py-2 px-2">Sign in</LoginLink>
        <RegisterLink postLoginRedirectURL="/dashboard" className="items-center font-bold rounded-lg flex gap-4 md:border-2 border-2 border-slate-300 py-2 px-2">Sign up</RegisterLink>
